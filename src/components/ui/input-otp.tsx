...
// Define the expected context structure based on input-otp documentation
// We use RenderProps from 'input-otp' and extend it to ensure 'slots' is present
interface OTPInputContextValue extends RenderProps {
  slots: {
    char: string;
